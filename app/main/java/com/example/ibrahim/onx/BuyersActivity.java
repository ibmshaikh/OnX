...
public class BuyersActivity extends AppCompatActivity {
        ...
        if (connec.getNetworkInfo(0).getState() == android.net.NetworkInfo.State.CONNECTED ||
            ...
            fab.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(BuyersActivity.this, AlbumSelectActivity.class);
            ...
            Toast.makeText(BuyersActivity.this, "It seems u don't have intenet connection", Toast.LENGTH_LONG).show();
    ...
    public void load(int yy){
        ...
        Query q = FirebaseDatabase.getInstance().getReference().child("Buyers").orderByChild("ordering").limitToFirst(yy*TOTAL_ITEMS_TO_LOAD);


        madapter = new FirebaseRecyclerAdapter<buyersclass, BuyersActivity.UserViewHolder>(buyersclass.class, R.layout.buyers_single, BuyersActivity.UserViewHolder.class, q) {
            @Override
            protected void populateViewHolder(final UserViewHolder viewHolder, final buyersclass model, int position) {
               ...
               // Toast.makeText(BuyersActivity.this,fullName,Toast.LENGTH_SHORT).show();
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent i=new Intent(BuyersActivity.this,Buyers_chat.class);
    ...
    public void buu(View view){
        Intent i=new Intent(BuyersActivity.this,Fill_buyers.class);
        startActivity(i);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ConstantsCustomGallery.REQUEST_CODE && resultCode == Activity.RESULT_OK && data != null) {
            ...
            Intent d=new Intent(BuyersActivity.this,Fill_buyers.class);
