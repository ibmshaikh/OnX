...
public class Fill_Seller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fill__seller);



        name=(EditText) findViewById(R.id.name);
        mdi = new ProgressDialog(Fill_Seller.this);
            ...
            fileToUpload.putFile(mResults.get(i)).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    if (finalI == 4) {
                        ...
                        Query q = FirebaseDatabase.getInstance().getReference().child("Seller").limitToLast(1);
                        q.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for (DataSnapshot childSnapShot : dataSnapshot.getChildren()) {
                                    ...
                                    DatabaseReference db = FirebaseDatabase.getInstance().getReference().child("Seller");
                                    db.push().setValue(h).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            ...
                                            c.put("waah",user+b);
                                            mm.push().setValue(c);
                                            Toast.makeText(Fill_Seller.this, "Successfull", Toast.LENGTH_SHORT).show();
                                            mdi.dismiss();
